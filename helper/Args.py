...
def getArgs():
    ...
    parser.add_argument("--neighbor", type=int, default=9, help="the neighborhood size for computation key for hash")
    ...
    parser.add_argument("--Qstrength", type=int, default=3, help="quantization factor of strength")
    parser.add_argument("--Qcoherence", type=int, default=3, help="quantization factor of coherence")
